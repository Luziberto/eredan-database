<template>
  <div class="text-md text-start">
    <p class="text-center text-sm border-b border-black py-1">{{ card.serie }}</p>
    <div class="flex flex-col border-b border-black py-2 text-start">
    ...
    <div
      ...
      class="col-span-2 py-2 border-b border-black"
    >
