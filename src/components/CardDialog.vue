<template>
  <div
    :class="`dialog ${getOrientationDialogProps(orientation)} overflow-y-auto fixed z-50 bg-red-100 rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-xl w-3/4 sm:p-6 lg:w-1/5 h-2/3 lg:h-auto`"
  >
    ...
    <div class="flex items-center justify-center py-2 text-xl border-b border-black font-bold item-center">
      <img
        class="lg:w-auto"
